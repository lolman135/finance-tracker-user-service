...
class FindUserByFullNameUseCaseTest {
    ...
    @Test
    fun `execute should return user when found by full name`() {
        // Arrange
        val firstName = "John"
        val lastName = "Doe"
        ...
        whenever(userRepository.findByFullName(firstName, lastName)).thenReturn(user)
    ...
    @Test
    fun execute_should_throw_exception_when_user_not_found_by_full_name() {
        // Arrange
        val firstName = "Unknown"
        val lastName = "User"
        val command = FindUserByFullNameCommand(firstName, lastName)
        whenever(userRepository.findByFullName(firstName, lastName)).thenReturn(null)
